...
import urllib2
import json
from utils._datacheck import isHealthy
...
class SiteMethods( ScrapeBase ):
    ...
    def go(self):
        ...
        for div in divs:
            self.url = self.url.encode('ascii') # site is unicode object. Convert it to a string
            ...
            product_dict[self.category] = products
