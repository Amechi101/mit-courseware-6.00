...
import os
import queue
from src.GoogleScraper.log import setup_logger
from src.GoogleScraper.commandline import get_command_line
from src.GoogleScraper.database import ScraperSearch, SERP, Link, get_session, fixtures
from src.GoogleScraper.proxies import parse_proxy_file, get_proxies_from_mysql_db, add_proxies_to_db
from src.GoogleScraper.caching import CacheManager
from src.GoogleScraper.config import get_config
from src.GoogleScraper.scrape_jobs import default_scrape_jobs_for_keywords
from src.GoogleScraper.scraping import ScrapeWorkerFactory
from src.GoogleScraper.output_converter import init_outfile
from src.GoogleScraper.async_mode import AsyncScrapeScheduler
import logging
from src.GoogleScraper.utils import get_base_path
import src.GoogleScraper.config
...
def scrape_with_config(config):
    ...
    Returns:
        ...
        ```from src.GoogleScraper database import session```
    """
...
def main(return_results=False, parse_cmd_line=True, config_from_dict=None):
    ...
    if config.get('version'):
        from src.GoogleScraper.version import __version__
        print(__version__)
        return
    ...
    from src.GoogleScraper.output_converter import close_outfile
    close_outfile()
