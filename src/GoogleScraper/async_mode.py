...
from src.GoogleScraper.http_mode import get_GET_params_for_search_engine, headers
from src.GoogleScraper.scraping import get_base_search_url_by_search_engine
from src.GoogleScraper.utils import get_some_words
